...
from dataset.prepare_lyft_data import level5data,get_paths
...
def create_tf_feature(image_file_path: pathlib.PosixPath,
    ...
    feature_dict = {
        ...
        'image/object/bbox/xmin': dataset_utils.float_list_feature(corner_list[:, 0] / float(image_width)),
        'image/object/bbox/xmax': dataset_utils.float_list_feature(corner_list[:, 1] / float(image_width)),
        'image/object/bbox/ymin': dataset_utils.float_list_feature(corner_list[:, 2] / float(image_height)),
        'image/object/bbox/ymax': dataset_utils.float_list_feature(corner_list[:, 3] / float(image_height)),
        'image/object/class/text': dataset_utils.bytes_list_feature(classes_text_list),
        'image/object/class/label': dataset_utils.int64_list_feature(box_feature_list[2]),
        'image/object/class/anns_id': dataset_utils.bytes_list_feature(anns_token_list)
    }
