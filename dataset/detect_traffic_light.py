...
from helpers.vis_util import plot_intermediate_image, draw_result_on_image
...
MODEL_NAME='faster_rcnn_lyft'
MODEL_FILE = MODEL_NAME + '.tar.gz'
DOWNLOAD_BASE = 'http://download.tensorflow.org/models/object_detection/'

# Path to frozen detection graph. This is the actual model that is used for the object detection.
model_path = "./object_detecton_models/models/"
PATH_TO_CKPT = model_path + MODEL_NAME + '/frozen_inference_graph.pb'
print('Path to object detection model is {}'.format(PATH_TO_CKPT))
