...
# DATA_DIR = "/media/jarvis/CommonFiles/Reference/frustum-pointnets"
DATA_DIR = "/scratch/jbandl2s/kitti"
...
class FrustumDataset(Sequence):
    ...
    def __init__(self, npoints, split, batch_size=32,
        ...
        if overwritten_data_path is None:
            overwritten_data_path = os.path.join(DATA_DIR,
...
if __name__ == '__main__':
    ...
    sys.path.append(os.path.join(DATA_DIR, 'mayavi'))
    from viz_util import draw_lidar, draw_gt_boxes3d
    ...
    for i in range(len(dataset)):
        data = dataset[i]
        print(('FrustumPC_Shape:', np.shape(data[0]),'Center: ', data[2],
