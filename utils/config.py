...
cfg.DATA.DATA_PATH = 'F:/LyftDataset/v1.01-train/'
cfg.DATA.TRAIN_JSON_PATH = osp.join(cfg.DATA.DATA_PATH, 'v1.01-train/')
cfg.DATA.TEST_JSON_PATH = osp.join(cfg.DATA.DATA_PATH, 'test_data')

cfg.DATA.CLASSES = ["car", "motorcycle", "bus", "bicycle", "truck", "pedestrian", "other_vehicle", "animal",
                    "emergency_vehicle"]
cfg.DATA.AVG_CAT_HEIGHTS = {'animal': 0.51, 'bicycle': 1.44, 'bus': 3.44, 'car': 1.72, 'emergency_vehicle': 2.39,
                            'motorcycle': 1.59, 'other_vehicle': 3.23, 'pedestrian': 1.78, 'truck': 3.44}
cfg.DATA.RANDOM_SAMPLES = {'car': 15, 'motorcycle': 1, 'bus': 1, 'bicycle': 1, 'truck': 1, 'pedestrian': 1,
                           'other_vehicle': 1, 'animal': 1, 'emergency_vehicle': 1}
