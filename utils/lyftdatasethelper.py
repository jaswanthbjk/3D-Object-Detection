...
class LyftDatasetHelper:
    ...
    def __init__(self, data_path: str, json_path: str, verbose: bool = True, map_resolution: float = 0.1):
        ...
        self.image_annotations = self.__load_table__("image_annotations", verbose)
    ...
    def get(self, table_name: object, token: object) -> object:
...
class LyftDatasetExplorer:
    ...
    def __init__(self, lyftd: LyftDatasetHelper):
        self.lyftd = lyftd
