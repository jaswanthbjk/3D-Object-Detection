...
flags.DEFINE_boolean("from_rgb", True, "whether from RGB detection")
flags.DEFINE_boolean("use_multisweep", False, "Use multisweep to collect Lidar points")
flags.DEFINE_boolean("use_detected_2d", True, "Load predetected 2D data")
...
class SceneProcessor(object):
    ...
    def process_one_scene(self, scene_num):
        ...
        file_save_path = os.path.join(artifact_path, 'test_frustums')
        with tf.io.TFRecordWriter(
                os.path.join(file_save_path,
